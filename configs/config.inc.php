...
$dbuser = 'shawnqiang';						// database user
$dbpasswd = '19840508';					// database user password
$dbname = 'aiqiao';				// database user
$pconnect = 0;							// if database long connect

/**
 * set cookie
 */
$cookiepre = '4J8_';					// cookie prefix
 ...
 */
$absolute_uri = 'http://dev.aiqiao.com/';
