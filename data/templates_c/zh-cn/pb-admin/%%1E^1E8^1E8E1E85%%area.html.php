<?php /* Smarty version 2.6.18, created on 2012-01-01 06:03:35
         compiled from area.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'sprintf', 'area.html', 19, false),)), $this); ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a class="btn1" href="area.php"><span><?php echo $this->_tpl_vars['_management']; ?>
</span></a></li>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['_area_levels'])) ? $this->_run_mod_handler('sprintf', true, $_tmp, $this->_tpl_vars['stat_item']['level']) : sprintf($_tmp, $this->_tpl_vars['stat_item']['level'])); ?>
...
">
		  <input type="hidden" name="aid[]" value="<?php echo $this->_tpl_vars['item']['id']; ?>
" />
		  </td>
		  <td><input type="text" name="data[aname][]" value="<?php echo $this->_tpl_vars['item']['name']; ?>
"></td>
...
"></td>
		  ...
		  <td><a title="<?php echo $this->_tpl_vars['Types'][$this->_tpl_vars['item']['areatype_id']]; ?>
" href="area.php?do=search&typeid=<?php echo $this->_tpl_vars['item']['areatype_id']; ?>
"><?php echo $this->_tpl_vars['Types'][$this->_tpl_vars['item']['areatype_id']]; ?>
</a></td>
		  <td class="handler">
          <ul id="handler_icon">
            <li><a class="btn_up" href="area.php?do=level&action=up&id=<?php echo $this->_tpl_vars['item']['id']; ?>
<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_throw_up']; ?>
"><?php echo $this->_tpl_vars['_throw_up']; ?>
</a></li>
            <li><a class="btn_down" href="area.php?do=level&action=down&id=<?php echo $this->_tpl_vars['item']['id']; ?>
<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_throw_down']; ?>
"><?php echo $this->_tpl_vars['_throw_down']; ?>
</a></li>
            <li><a class="btn_edit" href="area.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
<?php echo $this->_tpl_vars['addParams']; ?>
