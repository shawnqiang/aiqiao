<?php /* Smarty version 2.6.18, created on 2012-01-01 12:47:56
         compiled from fairtype.html */ ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a href="fair.php"><?php echo $this->_tpl_vars['_management']; ?>
</a></li>
		<li><a class="btn1" href="fairtype.php"><span><?php echo $this->_tpl_vars['_sorts']; ?>
</span></a></li>
        <li><a href="fairtype.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
    <div class="fontl"><?php echo $this->_tpl_vars['_default_domestic_and_international_exhibitions']; ?>
</div> 
    <div class="fontr"></div> 
</div> 
<div class="tdare">
  <form name="list_frm" id="ListFrm" action="fairtype.php" method="post">
...
"><?php echo $this->_tpl_vars['item']['name']; ?>
		  ...
		  <td class="handler">
          <ul id="handler_icon">
            <li><a class="btn_delete" href="fairtype.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&do=del" title="<?php echo $this->_tpl_vars['_delete']; ?>
"><?php echo $this->_tpl_vars['_delete']; ?>
</a></li>
            <li><a class="btn_edit" href="fairtype.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
