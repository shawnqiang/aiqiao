<?php /* Smarty version 2.6.18, created on 2012-01-01 06:06:42
...
" class="formbtn batchButton"/>
      <select name="pb_action" id="PbAction" onchange="javascript:document.list_frm.submit()">
        <option value="-1"><?php echo $this->_tpl_vars['_action']; ?>
</option>
        <optgroup label="<?php echo $this->_tpl_vars['_action']; ?>
<?php echo $this->_tpl_vars['_lists']; ?>
">
        <option value="0"><?php echo $this->_tpl_vars['_checked_status']; ?>
</option>
        <option value="1"><?php echo $this->_tpl_vars['_check_passed']; ?>
</option>
        <option value="2"><?php echo $this->_tpl_vars['_no_verify_passing']; ?>
</option>
        <option value="none"><?php echo $this->_tpl_vars['_moderated']; ?>
</option>
        <option value="3"><?php echo $this->_tpl_vars['_check_invalid']; ?>
</option>
        </optgroup>
      </select>
    </div>
