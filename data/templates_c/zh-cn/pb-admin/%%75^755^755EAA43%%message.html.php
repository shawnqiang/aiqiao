<?php /* Smarty version 2.6.18, created on 2012-01-01 06:07:15
         compiled from message.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'message.html', 40, false),)), $this); ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a class="btn1" href="message.php"><span><?php echo $this->_tpl_vars['_management']; ?>
</span></a></li>
        <li><a href="message.php?do=send"><?php echo $this->_tpl_vars['_send']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
    <div class="fontr"> 
        <form name="search_frm" action="message.php" id="SearchFrm" method="get"> 
...
<div class="tdare">
  <form name="list_frm" id="ListFrm" action="message.php" method="post">
...
"></th>
		  ...
		  <th><?php echo $this->_tpl_vars['_sender']; ?>
</th>
		  <th><?php echo $this->_tpl_vars['_accepter']; ?>
</th>
		  <th><?php echo $this->_tpl_vars['_the_title']; ?>
/<?php echo $this->_tpl_vars['_content_n']; ?>
</th>
		  <th><?php echo $this->_tpl_vars['_send_time']; ?>
</th>
...
?>
		<tr class="tatr2" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['content'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100) : smarty_modifier_truncate($_tmp, 100)); ?>
">
...
"><?php echo $this->_tpl_vars['item']['id']; ?>
		  ...
		  <td><?php echo $this->_tpl_vars['item']['cache_from_username']; ?>
</td>
		  <td><?php echo $this->_tpl_vars['item']['cache_to_username']; ?>
</td>
		  <td><?php echo $this->_tpl_vars['item']['title']; ?>
<br /><small><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['content'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100) : smarty_modifier_truncate($_tmp, 100)); ?>
</small></td>
		  <td class="pb_datetime"><?php echo $this->_tpl_vars['item']['pubdate']; ?>
</td>
		  <td class="handler">
          <ul id="handler_icon">
            <li><a class="btn_delete" href="message.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
