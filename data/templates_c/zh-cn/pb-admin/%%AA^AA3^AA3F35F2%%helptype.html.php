<?php /* Smarty version 2.6.18, created on 2012-01-01 07:28:06
         compiled from helptype.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'helptype.html', 41, false),)), $this); ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
        ...
        <li><a class="btn1" href="helptype.php"><span><?php echo $this->_tpl_vars['_sorts']; ?>
</span></a></li>        
        <li><a href="helptype.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
...
"></th>
		  <th><label for="idAll"><?php echo $this->_tpl_vars['_content_digest']; ?>
</label></th>
		  <th><?php echo $this->_tpl_vars['_the_title']; ?>
</th>
		  <th><?php echo $this->_tpl_vars['_grade']; ?>
</th>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['description'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100) : smarty_modifier_truncate($_tmp, 100)); ?>
</label></td>
		  <td><a title="<?php echo $this->_tpl_vars['_click_preview']; ?>
" href="<?php echo $this->_tpl_vars['SiteUrl']; ?>
help/index.php?typeid=<?php echo $this->_tpl_vars['item']['id']; ?>
" target="_blank"><?php echo $this->_tpl_vars['item']['title']; ?>
		  ...
		  <td class="handler">
           <ul id="handler_icon">
            <li><a class="btn_delete"  href="helptype.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
&do=del<?php echo $this->_tpl_vars['addParams']; ?>
" title="<?php echo $this->_tpl_vars['_delete']; ?>
"><?php echo $this->_tpl_vars['_delete']; ?>
</a></li>
            <li><a class="btn_edit" href="helptype.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
