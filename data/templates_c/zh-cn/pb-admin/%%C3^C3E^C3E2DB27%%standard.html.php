<?php /* Smarty version 2.6.18, created on 2012-01-01 06:06:52
         compiled from standard.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'standard.html', 43, false),)), $this); ?>
...
<div id="rightTop"> 
    ...
    <ul class="subnav">
		<li><a class="btn1" href="standard.php"><span><?php echo $this->_tpl_vars['_management']; ?>
</span></a></li>
        <li><a href="standard.php?do=edit"><?php echo $this->_tpl_vars['_add_or_edit']; ?>
</a></li>
        <li><a href="standard.php?do=type"><?php echo $this->_tpl_vars['_sorts']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
...
"><?php echo $this->_tpl_vars['item']['title']; ?>
		  ...
		  <td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['digest'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 50) : smarty_modifier_truncate($_tmp, 50)); ?>
</td>
		  <td class="handler">
          <ul id="handler_icon">
            <li><a class="btn_delete"  href="standard.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
...
standard.php?id=<?php echo $this->_tpl_vars['item']['id']; ?>
" target="_blank" title="<?php echo $this->_tpl_vars['_preview']; ?>
"><?php echo $this->_tpl_vars['_preview']; ?>
</a></li>
            <li><a class="btn_edit" href="standard.php?do=edit&id=<?php echo $this->_tpl_vars['item']['id']; ?>
