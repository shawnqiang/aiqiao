<?php /* Smarty version 2.6.18, created on 2012-01-01 06:13:29
...
<div id="currentPosition">
 ...
 &raquo; <?php echo $this->_tpl_vars['_log_browse']; ?>
</p>
</div>
<div id="rightTop"> 
    <h3><?php echo $this->_tpl_vars['_log_browse']; ?>
</h3> 
    <ul class="subnav">
		<li><a class="btn1" href="log.php"><span><?php echo $this->_tpl_vars['_administrator']; ?>
 <?php echo $this->_tpl_vars['_logs']; ?>
</span></a></li>
        <li><a href="log.php?do=clear"><?php echo $this->_tpl_vars['_clearing']; ?>
</a></li>
    </ul>
</div>
<div class="mrightTop"> 
...
"></th>
		  <th><label for="idAll"><?php echo $this->_tpl_vars['_grade']; ?>
</label></th>
		  <th><?php echo $this->_tpl_vars['_digest']; ?>
</th>
		  <th><?php echo $this->_tpl_vars['_source_n']; ?>
</th>
		  <th><?php echo $this->_tpl_vars['_date_and_time']; ?>
</th>
...
"></td>
		  <td><img src="<?php echo $this->_tpl_vars['item']['label']; ?>
" /></td>
		  <td><label for="item_<?php echo $this->_tpl_vars['item']['id']; ?>
"><?php echo $this->_tpl_vars['item']['description']; ?>
</label></td>
		  <td><?php echo $this->_tpl_vars['item']['source_module']; ?>
</td>
		  <td class="pb_datetime"><?php echo $this->_tpl_vars['item']['pubdate']; ?>
</td>
		  <td class="handler">
          <ul id="handler_icon">
            <li><a class="btn_delete" href="log.php?do=del&id=<?php echo $this->_tpl_vars['item']['id']; ?>
