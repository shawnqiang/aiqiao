...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'default/header.html', 7, false),array('modifier', 'truncate_multi', 'default/header.html', 8, false),array('modifier', 'sprintf', 'default/header.html', 77, false),array('modifier', 'default', 'default/header.html', 110, false),array('function', 'the_url', 'default/header.html', 24, false),array('function', 'get_cache', 'default/header.html', 89, false),array('block', 'cacheless', 'default/header.html', 72, false),array('block', 'tag', 'default/header.html', 116, false),)), $this); ?>
<?php $this->_cache_serials['/home/shawnqiang/www/aiqiao/data/templates_c/zh-cn/site/default//%%81^81F^81F6D955%%header.html.inc'] = '713975d226e1d548828f5fb6653f0b96'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div id="header">
    <div class="headtop">
    <?php if ($this->caching && !$this->_cache_including): echo '{nocache:713975d226e1d548828f5fb6653f0b96#0}'; endif;$this->_tag_stack[] = array('cacheless', array()); $_block_repeat=true;smarty_block_cacheless($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <p class="headtopcon">
...
" ><strong>[<?php echo $this->_tpl_vars['_free']; ?>
 <?php echo $this->_tpl_vars['_register']; ?>
    ...
    <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_cacheless($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:713975d226e1d548828f5fb6653f0b96#0}'; endif;?>
    </div>
