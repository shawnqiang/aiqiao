<?php /* Smarty version 2.6.18, created on 2012-01-18 12:40:01
...
$this->_smarty_include(array('smarty_include_tpl_file' => "header.html", 'smarty_include_vars' => array('PageTitle' => ($this->_tpl_vars['_space_news']),'cur' => 'space_news')));
...
<div id="content" class="container">
	<div class="row">
			...
			<div class="span12">
				<div class="mod">
					<div class="mod-hd">
						<h2><?php echo $this->_tpl_vars['_space_news']; ?>
</h2>
					</div>
					<div class="mod-bd">
						...
						<p class="companytitle"><?php echo $this->_tpl_vars['companynews']['link']; ?>
</p>
						<p><?php echo ((is_array($_tmp=$this->_tpl_vars['companynews']['content'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100) : smarty_modifier_truncate($_tmp, 100)); ?>
</p>
