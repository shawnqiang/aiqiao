...
array('name' => 'account','title'=>'收款账号','type' => 'text',   'value' => ''),
array('name' => 'currency','title'=>'货币','type' => 'text',   'value' => '')
);
/**
 * 类
 */
class paypal
{
    ...
    function redirect($order, $payment)
    {
        ...
        $def_url  = '<img src="images/loading.gif" /><br /><form style="text-align:center;" name="paysubmit" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_self">' .   // 不能省略
